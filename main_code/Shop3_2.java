 ...
 * @8.9.2020
 */
public class Shop3_2 extends Shop
{
    /**
     ...
     */
    public Shop3_2(Farm farm) { //pass in the farm data, including the farmer
        super();
        this.farm = farm;
    ...
    public void act() {
        ...
        if (Greenfoot.mouseClicked(leftArrow)) {
            Greenfoot.setWorld(new Shop3_1(farm));
        }
        else if (Greenfoot.mouseClicked(rightArrow)) {
            Greenfoot.setWorld(new Shop3_3(farm));
        }
    }    
